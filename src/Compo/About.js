...
function About() {
  return (
    <>
     {/* <section class="about">
           <div class="main">
            <img src="https://ik.imagekit.io/mohdrahil101/files/aboutpic.png?ik-sdk-version=javascript-1.4.3&updatedAt=1668283931523" alt=""/>
            <div class="abt-text">
                <h1>About <span>Us</span></h1>
                <p>Firstflight Travels is a travel website project developed by Mohd. Rahil using HTML and CSS.</p>
